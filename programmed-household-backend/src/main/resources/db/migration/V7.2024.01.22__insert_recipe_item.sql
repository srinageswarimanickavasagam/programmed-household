SET @recipe_id := (SELECT id
                   FROM programmedhousehold.recipe
                   WHERE title = 'Ven Pongal');
...
SET @recipe_id := (SELECT id
                   FROM programmedhousehold.recipe
                   WHERE title = 'Wheat Poori-Channa masala');
...
SET @recipe_id := (SELECT id
                   FROM programmedhousehold.recipe
                   WHERE title = 'Ragi Poori-Potato masala');
...
SET @recipe_id := (SELECT id
                   FROM programmedhousehold.recipe
                   WHERE title = 'Aloo Poori-Green peas masala');
